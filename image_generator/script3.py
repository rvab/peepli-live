...
def render_card(team_wishes, employee_name, employee_img_path, output_path):
    ...
    card = Image.open(os.path.join(BASE_DIR, 'card_template_3.png'))

    # Load, resize, and make the employee's profile picture round with 150% size
    employee_img = make_circle_image(employee_img_path, (200, 200), 2)
    ...
    draw.text((580, 380), f"Happy Anniversary {employee_name}!", font=font_bold_large, fill="#9eaf8e")
