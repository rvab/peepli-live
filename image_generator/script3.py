...
card = Image.open('card_template_3.png')

# Load, resize, and make the employee's profile picture round with 150% size
employee_img = make_circle_image('john_profile.png', (200, 200), 2)

# Paste the employee's circular image onto the card
card.paste(employee_img, (60, 140), employee_img)

# Initialize ImageDraw object
draw = ImageDraw.Draw(card)

# Choose fonts: regular, bold for names, and bold for anniversary message
font_regular = ImageFont.truetype("Lato-Regular.ttf", 20)  # Regular font
font_bold = ImageFont.truetype("Lato-Bold.ttf", 20)      # Bold font
font_bold_large = ImageFont.truetype("Pacifico-Regular.ttf", 60)  # Bold font for anniversary message

# Add employee's name and anniversary message (in bold and larger)
draw.text((580, 380), "Happy Anniversary Jane Doe!", font=font_bold_large, fill="#9eaf8e")
...
# Save the final card
card.save('work_anniversary_card_1.png')
