...
card = Image.open('card_template_2.png')

# Load, resize, and make the employee's profile picture round with 150% size
employee_img = make_circle_image('john_profile.png', (240, 240), 2)
...
draw.text((580, 150), "Happy Anniversary Jane Doe!", font=font_bold_large, fill="#0f94ab")
...
# Save the final card
card.save('work_anniversary_card.png')
