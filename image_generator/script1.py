...
card = Image.open('card_template_1.jpg')

# Load, resize, and make the employee's profile picture round with 150% size
employee_img = make_circle_image('john_profile.png', (400, 400), 2)
...
font_regular = ImageFont.truetype("Lato-Regular.ttf", 40)  # Regular font
font_bold = ImageFont.truetype("Lato-Bold.ttf", 40)      # Bold font
font_bold_large = ImageFont.truetype("Pacifico-Regular.ttf", 80)  # Bold font for anniversary message

# Add employee's name and anniversary message (in bold and larger)
draw.text((100, 1800), "Happy Anniversary Jane Doe!", font=font_bold_large, fill="red")
...
# Save the final card
card.save('work_anniversary_card.jpg')
